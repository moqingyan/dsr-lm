...
from run_w2v_bilstm import relation_id_map, CLUTRRModel, MLP
...
if __name__ == "__main__":
  ...
  parser.add_argument("--model-name", type=str, default="clutrr_ablation_w2v_bilstm.best.model")
  parser.add_argument("--lengths", nargs="+", type=int, default=[10])
