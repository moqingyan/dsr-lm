...
from experiments.clutrr.run_roberta_only import relation_id_map, CLUTRRModel, MLP
...
if __name__ == "__main__":
  ...
  parser.add_argument("--model-name", type=str, default="clutrr_roberta_baseline.best.model")
